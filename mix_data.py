...
def mix_and_create_dataset(type,dataset_root_path,output_path,file_num):

    dataset_name = type
    DATASET_PATH = dataset_root_path
    out_data_path = output_path + os.sep + type
    print(DATASET_PATH)
...
def mixData(dataset_root_path, output_root_path="./mix_data", type="train", num_file=1000):
    print('Mixing the data: Start processing...')
    mix_and_create_dataset(type, dataset_root_path, output_root_path, num_file)
