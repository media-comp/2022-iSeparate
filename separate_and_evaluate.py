...
def separate_and_evaluate(
    ...
    estimates = separator(model, audio, **eval_params)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--config", type=str, required=True, help="path to the evaluation config file"
    )
    parser.add_argument("--debug", action="store_true", help="do a debug run")
